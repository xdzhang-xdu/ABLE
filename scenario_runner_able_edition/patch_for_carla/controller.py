...
class VehiclePIDController():
    ...
    def run_step(self, target_speed, waypoint):
        ...
        #print("acc, speed, throttle, brake")
        #print(acceleration, get_speed(self._vehicle), control.throttle, control.brake)

        if self._vehicle.attributes["role_name"] != "ego_vehicle" and\
            acceleration >= 1.0 and get_speed(self._vehicle) <= 0.0:
