...
class Trace:
    ...
    def BUILD_single_traffic_rule_API(self, trace_state):
        ...
        self.trace["currentlane-forTrafficRule"]['number'].append(abs(ego_currentLane['number']))
        ...
        if 'upperLimit' in ego:
            max_speed = ego['upperLimit']
        # self.trace["speedLimit-forTrafficRule"]['upperLimit'].append(ego['upperLimit'])
