...
class ProxySet(Dataset):
    def __init__(self, testset, train):
        ...
        self.actions_to_index[','] = len(self.actions_list) - 2
        self.actions_to_index['.'] = len(self.actions_list) - 1
    ...
    def __getitem__(self, index):
        ...
        ### Add <pad> for every action
        #while len(actions_idx) < self.max_len:
        #    actions_idx.append(self.actions_to_index[','])
        ###
